...
For the noncontinuous case, we will use corresponding latent models from Yoon:2020hc et al (2020). See the paper (Yoon:2020hc et al, 2020) for more details. 
