...
We obtained a matrix X with 100 many rows (sample size) and 50 many columns (number of variables). All the variables have the sample type (continuous). Now we can use our main function `fpcaCor` to do functional principal component analysis.
